...
const T = {
  pt: {
    ...
    tut_caption_caos_1: 'Repare: a instrução lá em cima pede <b>2 coisas</b> (<b>VERMELHO</b> e <b>ESTRELA</b> — uma cor e uma forma!). Procure o único quadrado que tenha uma delas em qualquer uma das <b>3 partes</b> (forma, cor ou palavra). Aqui foi a <b>cor da figura</b> (<b>VERMELHO</b>).',
    tut_caption_caos_2: 'Antes de clicar, memorize as <b>outras 2 coisas</b> nesse quadrado: a forma (<b>QUADRADO</b>) e a palavra escrita nele (<b>ROXO</b>).',
    tut_caption_caos_3: 'Após memorizar, <b>clique</b> nessa figura.',
    tut_caption_caos_4: 'Agora encontre a figura com uma das coisas que você acabou de memorizar (<b>QUADRADO</b> ou <b>ROXO</b>) — dessa vez bateu na <b>palavra</b> (<b>ROXO</b>).',
    tut_caption_caos_5: 'Memorize as outras 2 coisas dessa figura: a forma (<b>CÍRCULO</b>) e a cor (<b>VERDE</b>).',
    tut_caption_caos_6: 'Após memorizar, <b>clique</b> nessa figura.',
    tut_caption_caos_7: 'É isso — o ciclo será sempre: <b>encontre uma das 2 coisas memorizadas (forma, cor ou palavra) → memorize as outras duas naquela figura → clique</b>, cada vez mais rápido. Bora jogar? 🚀',
  },
  en: {
    ...
    tut_caption_caos_1: "Notice: the instruction up top asks for <b>2 things</b> (<b>RED</b> and <b>STAR</b> — one color and one shape!). Look for the only square that has one of them in any of its <b>3 parts</b> (shape, color, or word) — here, it matched the <b>shape's color</b> (<b>RED</b>).",
    tut_caption_caos_2: "Before clicking, memorize the <b>other 2 things</b> on that square: the shape (<b>SQUARE</b>) and the word written on it (<b>PURPLE</b>).",
    tut_caption_caos_3: 'After memorizing, <b>click</b> that shape.',
    tut_caption_caos_4: "Now find the shape with one of the things you just memorized (<b>SQUARE</b> or <b>PURPLE</b>) — this time it matched the <b>word</b> (<b>PURPLE</b>).",
    tut_caption_caos_5: "Memorize the other 2 things on that shape: its shape (<b>CIRCLE</b>) and its color (<b>GREEN</b>).",
    tut_caption_caos_6: 'After memorizing, <b>click</b> that shape.',
    tut_caption_caos_7: "That's it — the cycle is always: <b>find one of the 2 memorized things (shape, color, or word) → memorize the other 2 on that shape → click</b>, getting faster each time. Ready to play? 🚀",
  },
  es: {
    ...
    tut_caption_caos_1: 'Fíjate: la instrucción de arriba pide <b>2 cosas</b> (<b>ROJO</b> y <b>ESTRELLA</b> — ¡un color y una forma!). Busca el único cuadrado que tenga una de ellas en cualquiera de sus <b>3 partes</b> (forma, color o palabra) — aquí, coincidió en el <b>color de la figura</b> (<b>ROJO</b>).',
    tut_caption_caos_2: 'Antes de hacer clic, memoriza las <b>otras 2 cosas</b> de ese cuadrado: la forma (<b>CUADRADO</b>) y la palabra escrita en él (<b>MORADO</b>).',
    tut_caption_caos_3: 'Después de memorizar, <b>haz clic</b> en esa figura.',
    tut_caption_caos_4: 'Ahora encuentra la figura con una de las cosas que acabas de memorizar (<b>CUADRADO</b> o <b>MORADO</b>) — esta vez coincidió en la <b>palabra</b> (<b>MORADO</b>).',
    tut_caption_caos_5: 'Memoriza las otras 2 cosas de esa figura: su forma (<b>CÍRCULO</b>) y su color (<b>VERDE</b>).',
    tut_caption_caos_6: 'Después de memorizar, <b>haz clic</b> en esa figura.',
    tut_caption_caos_7: 'Eso es todo — el ciclo siempre será: <b>encuentra una de las 2 cosas memorizadas (forma, color o palabra) → memoriza las otras 2 en esa figura → haz clic</b>, cada vez más rápido. ¿Vamos a jugar? 🚀',
  },
};
