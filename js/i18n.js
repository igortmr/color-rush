...
export const T = {
  pt: {
    ...
    dm_chat_no_guild: 'Você ainda não tem clã. Entre em um (ou crie o seu) pra conversar aqui.',
  ...
  en: {
    ...
    dm_chat_no_guild: "You don't have a guild yet. Join one (or create your own) to chat here.",
  ...
  es: {
    ...
    dm_chat_no_guild: 'Todavía no tienes clan. Únete a uno (o crea el tuyo) para conversar aquí.',
