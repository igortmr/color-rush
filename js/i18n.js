...
export const T = {
  pt: {
    ...
    weekly_pass_desc: '<p>Por 7 dias a partir da compra:</p><ul class="weekly-pass-benefits"><li>✓ nick com <b class="nick-pass-gold">cor exclusiva</b></li><li>✓ +100 <span id="weekly-pass-pigment-icon"></span> Pigmentos por dia <span class="muted">(700 no total)</span></li><li>✓ <b>+1 tentativa</b> no Desafio Diário</li></ul><p style="font-size:0.8em;">Compra única — não renova sozinha.</p>',
  ...
  en: {
    ...
    weekly_pass_desc: '<p>For 7 days from purchase:</p><ul class="weekly-pass-benefits"><li>✓ nickname with <b class="nick-pass-gold">exclusive color</b></li><li>✓ +100 <span id="weekly-pass-pigment-icon"></span> Pigments per day <span class="muted">(700 total)</span></li><li>✓ <b>+1 attempt</b> on the Daily Challenge</li></ul><p style="font-size:0.8em;">One-time purchase — does not auto-renew.</p>',
  ...
  es: {
    ...
    weekly_pass_desc: '<p>Durante 7 días desde la compra:</p><ul class="weekly-pass-benefits"><li>✓ apodo con <b class="nick-pass-gold">color exclusivo</b></li><li>✓ +100 <span id="weekly-pass-pigment-icon"></span> Pigmentos por día <span class="muted">(700 en total)</span></li><li>✓ <b>+1 intento</b> en el Desafío Diario</li></ul><p style="font-size:0.8em;">Compra única — no se renueva sola.</p>',
    weekly_pass_price: 'US$1,99',
