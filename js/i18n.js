...
export const T = {
  pt: {
    ...
    guild_battle_rules_p3: 'Enquanto a batalha de clãs estiver ativa, toda partida que você jogar nesses modos estará apta automaticamente a fazer parte das 5 melhores pontuações do seu clã. No máximo 2 das 5 melhores pontuações podem ser da mesma pessoa.',
    guild_battle_rules_p4: 'A pontuação do clã em cada modo é a média das 5 melhores pontuações de seus membros. A pontuação final do clã é a média das pontuações dos 2 modos.',
    guild_battle_rules_p5: 'Se dois clãs empatarem na pontuação final, o desempate é pela soma dos tempos de todas as partidas que entraram no Top 5 dos 2 modos — vence quem tiver a menor soma.',
    guild_battle_rules_p6: 'Qualquer pessoa pode acompanhar as melhores pontuações de qualquer clã em cada modo a qualquer momento.',
  ...
  en: {
    ...
    guild_battle_rules_p3: 'While the Guild Battle is active, every match you play in those modes is automatically eligible to become one of your guild\'s 5 best scores. At most 2 of those 5 best scores can belong to the same person.',
    guild_battle_rules_p4: 'A guild\'s score in each mode is the average of its members\' 5 best scores. The guild\'s final score is the average of the scores from the 2 modes.',
    guild_battle_rules_p5: 'If two guilds tie on final score, the tiebreaker is the sum of the durations of every match that made the Top 5 in both modes — whoever has the lower total wins.',
    guild_battle_rules_p6: 'Anyone can check the best scores of any guild in each mode at any time.',
  ...
  es: {
    ...
    guild_battle_rules_p3: 'Mientras la Batalla de Clanes esté activa, cada partida que juegues en esos modos será apta automáticamente para formar parte de las 5 mejores puntuaciones de tu clan. Como máximo 2 de esas 5 mejores puntuaciones pueden ser de la misma persona.',
    guild_battle_rules_p4: 'La puntuación del clan en cada modo es el promedio de las 5 mejores puntuaciones de sus miembros. La puntuación final del clan es el promedio de las puntuaciones de los 2 modos.',
    guild_battle_rules_p5: 'Si dos clanes empatan en la puntuación final, el desempate es por la suma de los tiempos de todas las partidas que entraron en el Top 5 de los 2 modos — gana quien tenga la suma menor.',
    guild_battle_rules_p6: 'Cualquiera puede seguir las mejores puntuaciones de cualquier clan en cada modo en cualquier momento.',
