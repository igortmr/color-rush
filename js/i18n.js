...
export const T = {
  pt: {
    ...
    guild_battle_rules_p1: 'A cada semana, <b>2 modos de jogo</b> são sorteados — os mesmos para todos os clãs. Enquanto a Batalha estiver ativa, toda partida que você jogar nesses modos entra automaticamente na pontuação do seu clã, sem precisar fazer nada especial.',
    guild_battle_rules_p2: 'Cada modo registra as <b>5 melhores pontuações</b> do clã naquele modo (o Top 5). No máximo <b>2 dessas 5</b> podem ser da mesma pessoa.',
    guild_battle_rules_p3: 'Em caso de empate de pontuação na hora de decidir quem entra no Top 5 (ou nas 2 melhores de uma mesma pessoa), quem tiver o <b>menor tempo de partida</b> leva a vaga.',
    guild_battle_rules_p4: 'A pontuação do clã em cada modo é a <b>média das 5 pontuações do Top 5</b> (vaga vazia conta como 0). A pontuação final do clã é a <b>média das pontuações dos 2 modos</b> sorteados.',
    guild_battle_rules_p5: 'Se dois clãs empatarem na pontuação final, o desempate é pela <b>soma dos tempos</b> de todas as partidas que entraram no Top 5 dos 2 modos — vence quem tiver a menor soma.',
    guild_battle_rules_p6: 'Qualquer pessoa pode acompanhar o Top 5 de qualquer clã em cada modo a qualquer momento, incluindo replay pra conferir a pontuação de perto.',
  ...
  en: {
    ...
    guild_battle_rules_p1: 'Every week, <b>2 game modes</b> are drawn — the same ones for every guild. While the Battle is active, every match you play in those modes automatically counts toward your guild\'s score, no extra steps needed.',
    guild_battle_rules_p2: 'Each mode records the guild\'s <b>5 best scores</b> in that mode (the Top 5). At most <b>2 of those 5</b> can belong to the same person.',
    guild_battle_rules_p3: 'On a score tie when deciding who makes the Top 5 (or someone\'s own 2 best), whoever has the <b>lower match duration</b> gets the spot.',
    ...
    guild_battle_rules_p5: 'If two guilds tie on final score, the tiebreaker is the <b>sum of the durations</b> of every match that made the Top 5 in both modes — whoever has the lower total wins.',
    guild_battle_rules_p6: 'Anyone can check any guild\'s Top 5 for each mode at any time, including a replay to review the score up close.',
  ...
  es: {
    ...
    guild_battle_rules_p1: 'Cada semana se sortean <b>2 modos de juego</b> — los mismos para todos los clanes. Mientras la Batalla esté activa, cada partida que juegues en esos modos cuenta automáticamente para la puntuación de tu clan, sin hacer nada especial.',
    guild_battle_rules_p2: 'Cada modo registra las <b>5 mejores puntuaciones</b> del clan en ese modo (el Top 5). Como máximo <b>2 de esas 5</b> pueden ser de la misma persona.',
    guild_battle_rules_p3: 'En caso de empate de puntuación a la hora de decidir quién entra en el Top 5 (o en las 2 mejores de una misma persona), quien tenga el <b>menor tiempo de partida</b> se queda con el puesto.',
    guild_battle_rules_p4: 'La puntuación del clan en cada modo es el <b>promedio de las 5 puntuaciones del Top 5</b> (una plaza vacía cuenta como 0). La puntuación final del clan es el <b>promedio de las puntuaciones de los 2 modos</b> sorteados.',
    guild_battle_rules_p5: 'Si dos clanes empatan en la puntuación final, el desempate es por la <b>suma de los tiempos</b> de todas las partidas que entraron en el Top 5 de los 2 modos — gana quien tenga la suma menor.',
    guild_battle_rules_p6: 'Cualquiera puede seguir el Top 5 de cualquier clan en cada modo en cualquier momento, incluida la repetición para revisar la puntuación de cerca.',
