...
export const T = {
  pt: {
    ...
    guild_battle_rules_p2: 'Cada modo registra as 5 melhores pontuações de cada clã. No máximo 2 dessas 5 melhores pontuações podem ser da mesma pessoa.',
    guild_battle_rules_p3: 'A pontuação do clã em cada modo é a média das 5 melhores pontuações de seus membros. A pontuação final do clã é a média das pontuações dos 2 modos.',
    guild_battle_rules_p4: 'Se dois clãs empatarem na pontuação final, o desempate é pela soma dos tempos de todas as partidas que entraram no Top 5 dos 2 modos — vence quem tiver a menor soma.',
    guild_battle_rules_p5: 'A Batalha de Clãs começa toda sexta-feira às 18h e termina domingo às 23h59 (horário de Brasília).',
  ...
  en: {
    ...
    guild_battle_rules_p2: 'Each mode records every guild\'s 5 best scores. At most 2 of those 5 best scores can belong to the same person.',
    guild_battle_rules_p3: 'A guild\'s score in each mode is the average of its members\' 5 best scores. The guild\'s final score is the average of the scores from the 2 modes.',
    guild_battle_rules_p4: 'If two guilds tie on final score, the tiebreaker is the sum of the durations of every match that made the Top 5 in both modes — whoever has the lower total wins.',
    guild_battle_rules_p5: 'The Guild Battle starts every Friday at 6 PM and ends Sunday at 11:59 PM (Brasília time).',
  ...
  es: {
    ...
    guild_battle_rules_p2: 'Cada modo registra las 5 mejores puntuaciones de cada clan. Como máximo 2 de esas 5 mejores puntuaciones pueden ser de la misma persona.',
    guild_battle_rules_p3: 'La puntuación del clan en cada modo es el promedio de las 5 mejores puntuaciones de sus miembros. La puntuación final del clan es el promedio de las puntuaciones de los 2 modos.',
    guild_battle_rules_p4: 'Si dos clanes empatan en la puntuación final, el desempate es por la suma de los tiempos de todas las partidas que entraron en el Top 5 de los 2 modos — gana quien tenga la suma menor.',
    guild_battle_rules_p5: 'La Batalla de Clanes empieza todos los viernes a las 18h y termina el domingo a las 23h59 (hora de Brasilia).',
