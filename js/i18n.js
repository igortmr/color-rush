...
export const T = {
  pt: {
    ...
    weekly_pass_web_soon: 'Compra pelo navegador ainda não está disponível — em breve!',
  ...
  en: {
    ...
    weekly_pass_web_soon: 'Browser purchase isn\'t available yet — coming soon!',
  ...
  es: {
    ...
    weekly_pass_web_soon: 'La compra por el navegador todavía no está disponible — ¡pronto!',
