...
export const T = {
  pt: {
    ...
    guild_battle_ends_in_label: 'Batalha de clãs termina em:',
    guild_battle_ended: 'Batalha encerrada — aguardando a próxima sexta-feira.',
    guild_battle_modes_title: '🎲 Modos Sorteados',
    guild_battle_final_score: 'Nota final do clã',
    guild_battle_overall_ranking: '🏆 Ranking Geral entre Clãs',
    guild_battle_mode_avg: 'média',
    guild_battle_no_scores_yet: 'Ninguém pontuou nesse modo ainda.',
    guild_battle_rules_title: 'Como funciona a pontuação',
    guild_battle_rules_p1: 'A cada semana, o jogo sorteia <b>2 modos de jogo</b> — os mesmos para todos os clãs. Enquanto a Batalha estiver ativa, toda partida que você jogar nesses modos entra automaticamente na pontuação do seu clã, sem precisar fazer nada especial: é só jogar normalmente.',
    guild_battle_rules_p2: 'Cada modo tem seu próprio Top 5 por clã: as 5 melhores pontuações do clã naquele modo. No máximo <b>2 das 5 vagas</b> podem ser da mesma pessoa (suas 2 melhores pontuações no modo), pra premiar clãs com mais gente participando.',
    guild_battle_rules_p3: 'Em caso de empate de pontuação — tanto pra entrar no Top 5 de um modo quanto no ranking geral entre clãs — quem tiver o <b>menor tempo de partida</b> fica na frente.',
    guild_battle_rules_p4: 'A nota do clã em cada modo é a <b>média das 5 pontuações do Top 5</b> (vaga vazia conta como 0). A nota final do clã é a <b>média das notas dos 2 modos</b> sorteados.',
    guild_battle_rules_p5: 'Se dois clãs empatarem na nota final, o desempate é pela <b>soma dos tempos</b> das partidas que entraram no Top 5 dos 2 modos — vence quem tiver a menor soma (vagas vazias não entram nessa soma).',
    guild_battle_rules_p6: 'Qualquer pessoa pode clicar num clã no ranking geral pra ver o Top 5 de cada modo, com nick, nível e um botão ▶️ de replay pra conferir a pontuação de perto.',
    guild_battle_rules_p7: 'A Batalha começa toda sexta-feira às 18h e termina domingo às 23h59 (horário de Brasília).',
  ...
  en: {
    ...
    guild_battle_ends_in_label: 'Guild battle ends in:',
    guild_battle_ended: 'Battle ended — waiting for next Friday.',
    guild_battle_modes_title: '🎲 Drawn Modes',
    guild_battle_final_score: 'Guild final score',
    guild_battle_overall_ranking: '🏆 Overall Guild Ranking',
    guild_battle_mode_avg: 'avg',
    guild_battle_no_scores_yet: 'No one has scored in this mode yet.',
    guild_battle_rules_title: 'How scoring works',
    guild_battle_rules_p1: 'Every week, the game draws <b>2 game modes</b> — the same ones for every guild. While the Battle is active, every match you play in those modes automatically counts toward your guild\'s score, no extra steps needed: just play as usual.',
    guild_battle_rules_p2: 'Each mode has its own Top 5 per guild: the guild\'s 5 best scores in that mode. At most <b>2 of those 5 slots</b> can belong to the same person (their 2 best scores in that mode), so guilds with more people playing are rewarded.',
    guild_battle_rules_p3: 'On a score tie — whether for a spot in a mode\'s Top 5 or in the overall guild ranking — whoever has the <b>lower match duration</b> comes out ahead.',
    guild_battle_rules_p4: 'A guild\'s score in each mode is the <b>average of its Top 5 scores</b> (an empty slot counts as 0). The guild\'s final score is the <b>average of the 2 drawn modes\'</b> scores.',
    guild_battle_rules_p5: 'If two guilds tie on final score, the tiebreaker is the <b>sum of match durations</b> for the entries that made the Top 5 in both modes — whoever has the lower total wins (empty slots aren\'t counted in that sum).',
    guild_battle_rules_p6: 'Anyone can click a guild in the overall ranking to see the Top 5 for each mode, with nick, level, and a ▶️ replay button to check the score up close.',
    guild_battle_rules_p7: 'The Battle starts every Friday at 6 PM and ends Sunday at 11:59 PM (Brasília time).',
  ...
  es: {
    ...
    guild_battle_ends_in_label: 'La batalla de clanes termina en:',
    guild_battle_ended: 'Batalla terminada — esperando el próximo viernes.',
    guild_battle_modes_title: '🎲 Modos Sorteados',
    guild_battle_final_score: 'Nota final del clan',
    guild_battle_overall_ranking: '🏆 Ranking General entre Clanes',
    guild_battle_mode_avg: 'promedio',
    guild_battle_no_scores_yet: 'Todavía nadie puntuó en este modo.',
    guild_battle_rules_title: 'Cómo funciona la puntuación',
    guild_battle_rules_p1: 'Cada semana, el juego sortea <b>2 modos de juego</b> — los mismos para todos los clanes. Mientras la Batalla esté activa, cada partida que juegues en esos modos cuenta automáticamente para la puntuación de tu clan, sin hacer nada especial: solo juega normalmente.',
    guild_battle_rules_p2: 'Cada modo tiene su propio Top 5 por clan: las 5 mejores puntuaciones del clan en ese modo. Como máximo <b>2 de esas 5 plazas</b> pueden ser de la misma persona (sus 2 mejores puntuaciones en el modo), para premiar a los clanes con más gente participando.',
    guild_battle_rules_p3: 'En caso de empate de puntuación — tanto para entrar en el Top 5 de un modo como en el ranking general entre clanes — quien tenga el <b>menor tiempo de partida</b> queda adelante.',
    guild_battle_rules_p4: 'La nota del clan en cada modo es el <b>promedio de las 5 puntuaciones del Top 5</b> (una plaza vacía cuenta como 0). La nota final del clan es el <b>promedio de las notas de los 2 modos</b> sorteados.',
    guild_battle_rules_p5: 'Si dos clanes empatan en la nota final, el desempate es por la <b>suma de los tiempos</b> de las partidas que entraron en el Top 5 de los 2 modos — gana quien tenga la suma menor (las plazas vacías no entran en esa suma).',
    guild_battle_rules_p6: 'Cualquiera puede hacer clic en un clan del ranking general para ver el Top 5 de cada modo, con nick, nivel y un botón ▶️ de repetición para revisar la puntuación de cerca.',
    guild_battle_rules_p7: 'La Batalla empieza todos los viernes a las 18h y termina el domingo a las 23h59 (hora de Brasilia).',
