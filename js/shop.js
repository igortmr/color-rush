...
export const SHOP_ITEMS = [
  ...
  { id: 'row_holo',      slot: 'rowTheme',   price: 4000, icon: '🌈', name: 'Linha: RGB',                     desc: 'Degradê iridescente que muda de cor sozinho.' },
  ...
  // pena promover pra produção; promovidas agora, CSS espelhado em
  ...
  { id: 'row_forest2',    slot: 'rowTheme', price: 5000, icon: '🌳', name: 'Linha: Floresta Mística', desc: 'Floresta encantada com lanterna, vagalumes e cachoeira.' },
  { id: 'row_yinyang',    slot: 'rowTheme', price: 5000, icon: '☯️', name: 'Linha: Yin Yang',        desc: 'Símbolo do yin yang com fumaça luminosa.' },
  { id: 'row_meteor',     slot: 'rowTheme', price: 5000, icon: '☄️', name: 'Linha: Chuva de Meteoros', desc: 'Meteoros em chamas cruzando o espaço.' },
  { id: 'row_dragon',     slot: 'rowTheme', price: 5000, icon: '🐉', name: 'Linha: Dragão',          desc: 'Dragão verde flamejante enrolado na linha.' },
  ...
  { id: 'row_aurora',     slot: 'rowTheme', price: 5000, icon: '🌠', name: 'Linha: Aurora',          desc: 'Aurora boreal verde e violeta sobre um céu estrelado — brilha de vez em quando.' },
...
function renderShop({ keepScroll = false } = {}) {
  $('shop-balance-icon').innerHTML = pigmentIconSvg(18);
